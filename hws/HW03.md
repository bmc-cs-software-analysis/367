...
due_date: 2026-09-25 23:59:00EDT
---
...
You can optionally work with a partner on this assignment. Only one submission is needed per group. Clearly state in your submission both partners names. 
...
2. Download the run_pitest.sh script I’ve created: `wget https://bmc-cs-software-analysis.github.io/367/hws/hw03/run_pitest.sh`  
3. Copy over your tests from HW1.   
4. Move the hamcrest and junit jars from the HW1 to the `lib` directory.   
...
`wget https://bmc-cs-software-analysis.github.io/367/hws/hw03/tests.zip`
