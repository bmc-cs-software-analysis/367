...
=============================================================
This homework is optionally completed in partners. If you complete this assignment with a partner, submit only once to gradescope and clearly state both group members.

## Objectives:

In this homework you will run a symbolic executor on Java programs and observe its outputs. 
...
3. Some targets in this homework did not have assertions, but the tool could still find bugs. Why? What does java path finder use for postconditions?
