...
I've included [starter code](https://github.com/bmc-cs-software-analysis/367/tree/main/hws/hw04/queryModel.sh) to query an LLM. For this assignment we'll use Mistral-7b: a model trained on both code and natural language. The "7b" refers to the size of the model (7 billion parameters). This is quite small in terms of modern LLMs. Chat-GPT4 has approximately 1.8 *trillion* parameters. 
...
`wget https://bmc-cs-software-analysis.github.io/367/hws/hw04/testPrefixes.txt` 
and  
`wget https://bmc-cs-software-analysis.github.io/367/hws/hw04/assertions.txt`
...
`wget https://bmc-cs-software-analysis.github.io/367/hws/hw04/corpus.txt`   and
`wget https://bmc-cs-software-analysis.github.io/367/hws/hw04/corpusAsserts.txt`

I've included some [starter code](https://github.com/bmc-cs-software-analysis/367/blob/main/hws/hw04/Jaccard.java). You should begin by filling in the TODOs.
